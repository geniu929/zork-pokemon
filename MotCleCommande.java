...
public class MotCleCommande {
	 ...
	 */
	private final static String commandesValides[] = {"inventaire", "retour", "aller", "quitter", "aide", "regarde", "ramasse", "depose","mission","pokemons","budget","acheter","guerir","capture"};
